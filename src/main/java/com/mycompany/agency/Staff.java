...
public class Staff
{
    ...
    public Staff()
    {
        ...
        staffList[0] = new Intern("Alice", "123 Anywhere Street", "555-5001");
        ...
        staffList[3] = new StaffEmployee("David", "987 Example Boulevard", "555-5004", "678-90-1234", 32.0);
        staffList[4] = new TempEmploee("Evelyn", "654 Test Parkway", "555-5005", "789-01-2345", 28.0);
        staffList[5] = new Executive("Felix", "321 Placeholder Lane", "555-5006", "890-12-3456", 40.0);
